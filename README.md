...
This is a fork of [SQANTI](https://bitbucket.org/ConesaLab/sqanti/src/master/). I made some minor adaptations to make it work as a submodule in my other workflows.
